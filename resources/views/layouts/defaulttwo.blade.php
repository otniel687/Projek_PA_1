...
<body>
  ...
  <section id="footer" class="bg-dark text-light">
    <div class="row" style="margin-bottom: 70px; margin-top: 35px">
      ...
      <div class="col-md-3">
        <a href="/kritik" class="btn btn-warning" style="width: 250px">Kritik Dan Saran</a><br><br>
      ...
      <footer>           
          <div>
            <div class="flex-c-m flex-w p-b-18">
                <a href="https://www.del.ac.id/" target="_blank" class="m-all-1" style="margin-right: 15px">
