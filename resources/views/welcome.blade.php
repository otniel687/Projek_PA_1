          ...
          <div class="row row-cols-1 row-cols-smb-4 row-cols-md-3 g-3 d-flex justify-content-center">
            ...
            <div class="col">
              <div class="card shadow-sm">
                <a href="{{ url('/desa') }} ">
                  <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="125" fill="currentColor" class="bi bi-x-diamond m-3" aria-label="Placeholder: Thumbnail" viewBox="0 0 16 16" focusable="false" style="color: #cc6511;">
                    <path
            ...
            <div class="col">
              <div class="card shadow-sm">
                <a href="/ulos ">
                  <svg width="100%" height="125" fill="currentColor" class="bi bi-x-diamond m-3" aria-label="Placeholder: Thumbnail" viewBox="0 0 16 16" focusable="false" style="color: #cc6511;">
                    <path
            ...
            <div class="col">
              <div class="d-flex justify-content-center card shadow-sm">
                ...
                <h3 class="text-center mb-4">Tentang Pengrajin</h3>
              </div>
            </div>
